...
export const GenericAddEditFormRelationship = ({
  Queries,
  Models,
  showFormDialog,
  setShowFormDialog,
  ...
  return (
    <Fragment>
      {ToastSuccessError(
        ...
        showToast,
        setShowToast,
        relationship01Result.called,
        relationship01Result.loading,
        relationship01Result.error
      )}
            {ToastSuccessError(
        toast,
        showToast,
        setShowToast,
        relationship02Result.called,
        relationship02Result.loading,
        relationship02Result.error
      )}
            {ToastSuccessError(
        toast,
        showToast,
        setShowToast,
        relationship03Result.called,
        relationship03Result.loading,
        relationship03Result.error
      )}
            {ToastSuccessError(
        toast,
        showToast,
        setShowToast,
        relationship04Result.called,
        relationship04Result.loading,
        relationship04Result.error
      )}
            {ToastSuccessError(
        toast,
        showToast,
        setShowToast,
        relationship05Result.called,
        relationship05Result.loading,
        relationship05Result.error
      )}
      {ToastSuccessError(
        toast,
        showToast,
